...
const PasswordOverview: React.FC<Username> = ({ username }) => {
  ...
  const handleDeletePassword = async (id: string) => {
    const confirDeletePassword = confirm(
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {isLoading ? (
                ...
                >
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <button
                        onClick={() =>
                          setVisiblePasswordId(isVisible ? "" : platform._id)
                        }
                      ...
                      <button
                        onClick={() =>
                          handleCopyPassword(platform._id, platform.password)
                        }
                        className="text-gray-500 hover:text-gray-700 mx-1"
                      >
                        {copiedPasswordId === platform._id ? (
          ...
          <div className="col-span-3 flex justify-center items-center p-6">
            {!username ? (
              <div className="bg-white rounded-lg shadow-md p-8 flex flex-col items-center max-w-sm w-full">
                <h2 className="text-xl font-semibold mb-4 text-gray-800">
                  Welcome to Password Manager
                </h2>
                <p className="mb-6 text-gray-600 text-center">
                  Please sign in to view your saved passwords, or create a new
                  account.
                </p>
                <div className="flex items-center space-x-2">
                  ...
                  <SignUpButton>
                    <button className="bg-white border border-black text-black px-4 py-2 rounded hover:bg-gray-100 transition">
                      Sign Up{" "}
